...
**Twee scoringsmodi:** op het setup-scherm is een schakelaar "Vooruitgang naar verhouding" te vinden (het (i)-icoontje ernaast toont een korte uitleg). Staat deze uit (standaard), dan loopt een kameel een hele stap vooruit zodra de meerderheid van het team de vraag goed had (het oorspronkelijke gedrag). Staat deze aan, dan loopt de kameel naar rato van het aantal juiste antwoorden — bijv. 6 van de 9 teamleden goed → 2/3 stap vooruit, in plaats van alles-of-niets (het resultatenscherm toont dan ook de breuk, bijv. "2/3 stap vooruit!"). De gekozen modus wordt opgeslagen bij het spel zelf, blijft dus ook na een herstart/herstel van het host-scherm hetzelfde, en de voorkeur wordt onthouden voor het volgende spel dat aangemaakt wordt. Spellen die al liepen vóór deze functie bestond, vallen automatisch terug op de meerderheidsmodus.
